 ...
 * operations (insert/remove) for bits or bytes. It the user want to
 ...
 *
 * Copyright 2021 Jonny Pettersson (jonny@cs.umu.se). Permission is
 * given for usage of this file within the course DV2 at Ume̴
